...
class TestNumberSensor(TestCase):
    ...
    def test_threshold_trigger_equal(self):
        ...
        self.assertEqual(SensorDataInt(0, "test unit"), sensor.sensorData)
    ...
    def test_threshold_trigger_lower_than(self):
        ...
        sensor.state = 0
        sensor.sensorData = SensorDataInt(2, "test unit")

        sensor.initialize()
        sensor.start()

        self.assertEqual(SensorDataInt(2, "test unit"), sensor.sensorData)
        ...
        self.assertFalse(events[0].hasOptionalData)
        self.assertIsNone(events[0].optionalData)
        self.assertEqual(SensorDataInt(0, "test unit"), events[0].sensorData)
    ...
    def test_threshold_trigger_greater_than(self):
        ...
        self.assertFalse(events[0].hasOptionalData)
        self.assertIsNone(events[0].optionalData)
        self.assertEqual(SensorDataInt(2, "test unit"), events[0].sensorData)
    ...
    def test_same_data(self):
        ...
        sensor.hasThreshold = False
        sensor.state = 0
        sensor.sensorData = SensorDataInt(1337, "test unit")
