...
from lib.sensor.provider import DarkskyDataCollector
from lib.globalData.sensorObjects import SensorErrorState


class MockDarkskyCollector(DarkskyDataCollector):

    def __init__(self, interval: int, api_key: str):
        super(MockDarkskyCollector, self).__init__(interval, api_key)
...
class TestDarksky(TestCase):
    ...
    def setUp(self):
        ...
        self._collector = MockDarkskyCollector(30, "Test")
    ...
    def test_integration_valid_data_processing(self):
        ...
        self.assertEqual(humidity.data, 84)
        ...
        self.assertEqual(temperature.data, 43.25)
        ...
        self.assertEqual(rain_forecast.data, 71)
        ...
        rain_forecast = self._collector.getForecastRain(self._country,
                                                        ...
                                                        1)
        self.assertIsNone(rain_forecast.error)
        self.assertEqual(rain_forecast.data, 93)
        ...
        rain_forecast = self._collector.getForecastRain(self._country,
                                                        ...
                                                        2)
        self.assertIsNone(rain_forecast.error)
        self.assertEqual(rain_forecast.data, 94)
        ...
        self.assertEqual(temp_forecast_low.data, 41.54)
        ...
        temp_forecast_low = self._collector.getForecastTemperatureLow(self._country,
                                                                      ...
                                                                      1)
        self.assertIsNone(temp_forecast_low.error)
        self.assertEqual(temp_forecast_low.data, 42.8)
        ...
        temp_forecast_low = self._collector.getForecastTemperatureLow(self._country,
                                                                      ...
                                                                      2)
        self.assertIsNone(temp_forecast_low.error)
        self.assertEqual(temp_forecast_low.data, 39.33)
        ...
        self.assertEqual(temp_forecast_high.data, 50.59)
        ...
        temp_forecast_high = self._collector.getForecastTemperatureHigh(self._country,
                                                                        ...
                                                                        1)
        self.assertIsNone(temp_forecast_high.error)
        self.assertEqual(temp_forecast_high.data, 52.26)
        ...
        temp_forecast_high = self._collector.getForecastTemperatureHigh(self._country,
                                                                        ...
                                                                        2)
        self.assertIsNone(temp_forecast_high.error)
        self.assertEqual(temp_forecast_high.data, 49.87)
