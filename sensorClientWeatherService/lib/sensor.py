...
class TempPollingSensor(_PollingSensor):
    ...
    def updateState(self):
        temp = self.dataCollector.getTemperature(self.country, self.city, self.lon, self.lat)
...
class ForecastRainPollingSensor(_PollingSensor):
